...
class SettingUserNamePage extends StatefulWidget {
  SettingUserNamePage({Key key, this.text}) : super(key: key);
  // 输入宽文字
  final String text;
  @override
...
class _SettingUserNamePageState extends State<SettingUserNamePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("设置名字", style: Theme.of(context).textTheme.headline1,),
  ...
  void _confirm() {
    ...
    updateUserInfoParam.name = _controller.text;
    GetDataTool.updateUserInfo(updateUserInfoParam, (value) {
      context.read<UserViewModel>().setName(updateUserInfoParam.name);
